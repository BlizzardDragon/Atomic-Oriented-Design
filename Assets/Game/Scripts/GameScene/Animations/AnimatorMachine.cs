...
using UnityEngine;
using IState = AtomicOrientedDesign.Shooter.IState;
...
namespace Game.GameEngine.Animation
{
        ...
        IDisable
    {
        ...
        [ShowInInspector, ReadOnly]
        private List<StateTransition> orderedTransitions;
        ...
        public void SetTransitions(params StateTransition[] transitions)
        {
            orderedTransitions = new(transitions);
        }
